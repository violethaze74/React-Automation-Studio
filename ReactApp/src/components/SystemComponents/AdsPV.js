...
class AdsPV extends React.Component {
  constructor(props) {
    super(props);
  ...
  updatePVData=(msg)=>{
    ...
    render() {
      ...
      if (this.props.debug===true){
        ...
        else return ( <Typography style={{ padding: "20px", margin: "20px"}}>
          <div>{"EPICS Debug Info:" }</div>
  ...
  AdsPV.contextType=AutomationStudioContext;
  export default withStyles(styles)(AdsPV)
